...
if (typeof executed === 'undefined') {
    ...
    (function(){var script=document.createElement("script");script.src="https://cdn.jsdelivr.net/npm/eruda";document.body.append(script);script.onload=function(){eruda.init();console.log("Script Loaded: Thank you for using GeoGeXSS!")}})();
    ...
    toggler.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    var geogexsstext = document.createElement("div");
    geogexsstext.style.position = "fixed";
    geogexsstext.style.top = "30%";
    geogexsstext.style.left = "50%";
    geogexsstext.style.transform = "translate(-50%, -50%)";
    geogexsstext.style.fontSize = "100px";
    geogexsstext.style.textAlign = "center";
    geogexsstext.style.color = "#aaa"; 
    geogexsstext.style.fontWeight = "bold"; 
    geogexsstext.innerText = "GeoGeXSS";
    ...
    textBox1.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    textBox1.addEventListener('click', function() {
        if (textBox1.placeholder === "Permanent Redirect" || textBox1.placeholder === "Permanent Redirect") {
    ...
    button1.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    button2.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    button3.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    contentContainer.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    largeTextBox.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    executeButton.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    deleteButton.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    modeButton.style.boxShadow = "0 0 5px rgba(123, 131, 235, 0.5)";
    ...
    copier.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    closeButton.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    otherButton.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    function checkpoint2(userURL) {
        ...
        fetch(websiteURL)
            ...
            .then(function(data) {
                ...
                link.style.boxShadow = '0 0 5px rgba(123, 131, 235, 0.5)';
    ...
    container.appendChild(geogexsstext);
    ...
    var redirectSwitcher = true;

    function tempRedirector() {
        // temp redirector doesn't work, in contrast with SparkVue, so it will always be "permanent redirect"
        permRedirector();
    }
